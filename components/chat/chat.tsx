...
export function ChatAssistant() {
  ...
  return (
    <>
      {/* Chat Button */}
      <motion.button
        className="flex h-12 w-12 items-center justify-center rounded-full bg-gradient-to-r from-cyan-600 to-blue-700 z-auto text-white shadow-lg"
        whileHover={{
          scale: 1.05,
          ...
          {isOpen && (
            <>
              <motion.div
                ...
                className="fixed bottom-1 right-2 bg-white rounded-xl shadow-2xl border border-gray-200 overflow-hidden z-30"
              >
                {/* Resize handles */}
                <div
