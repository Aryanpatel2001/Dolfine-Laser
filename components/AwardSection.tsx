...
//               width={650}
//               height={450}
//               className="rounded-xl shadow-2xl border-4 border-gray-200"
//             />
//           </motion.div>
...
//                     Winning the "Growth of Gujarat Make in India" award
//                   </span>{" "}
//                   from Gujarat Home Minister{" "}
//                   <span className="font-semibold">Mr. Harsh Sanghviji</span> for
//                   Dolphin Laser Machine Pvt Ltd is a **remarkable achievement**!
//                 </p>
//                 <p>
//                   It highlights the **outstanding contribution** of Dolphin
//                   Laser to both the **economic growth of Gujarat** and the
