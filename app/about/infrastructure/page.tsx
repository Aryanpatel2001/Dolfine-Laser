...
const Counter = ({
  ...
  return (
    <motion.div
      ...
      className="flex flex-col items-center justify-center rounded-xl bg-white p-4 sm:p-6 shadow-lg dark:bg-gray-800"
    >
      <div className="mb-2 sm:mb-3 flex h-12 sm:h-16 w-12 sm:w-16 items-center justify-center rounded-full bg-blue-100 text-blue-600 dark:bg-blue-900/30 dark:text-blue-400">
        <Icon size={24} className="sm:w-8 sm:h-8" />
      </div>
      <h3 className="mb-1 text-3xl sm:text-4xl font-bold text-gray-900 dark:text-white">
        {count}
      </h3>
...
const ImageGallery = ({
  ...
  return (
    <div className="relative h-[300px] sm:h-[400px] md:h-[500px] w-full overflow-hidden rounded-xl sm:rounded-2xl">
      ...
      <button
        ...
        className="absolute left-2 sm:left-4 top-1/2 flex h-8 w-8 sm:h-10 sm:w-10 -translate-y-1/2 items-center justify-center rounded-full bg-white/20 text-white transition-all hover:bg-white/40"
      ...
      <button
        onClick={handleNext}
        className="absolute right-2 sm:right-4 top-1/2 flex h-8 w-8 sm:h-10 sm:w-10 -translate-y-1/2 items-center justify-center rounded-full bg-white/20 text-white transition-all hover:bg-white/40"
...
const Page = (props: Props) => {
  ...
  return (
    <section
      ref={ref}
      className="relative overflow-hidden bg-gradient-to-b from-gray-50 to-gray-100 py-8 sm:py-12 md:py-16 lg:py-20 dark:from-gray-900 dark:to-gray-950 mt-6 sm:mt-8 md:mt-10"
    >
      ...
      <div className="absolute inset-0 z-0">
        <motion.div style={{ y }} className="absolute inset-0 opacity-30">
          ...
          <motion.div
            ...
            className="absolute left-1/4 top-1/3 h-24 sm:h-32 w-24 sm:w-32 rounded-full bg-blue-600/10 blur-2xl"
          ></motion.div>
          ...
          <motion.div
            ...
            className="absolute bottom-1/4 right-1/3 h-32 sm:h-40 w-32 sm:w-40 rounded-full bg-indigo-600/10 blur-2xl"
          ></motion.div>
        </motion.div>
        ...
        >
          <div className="mb-6 sm:mb-8 md:mb-12 text-center">
            <motion.div
              ...
              transition={{ duration: 0.6 }}
              viewport={{ once: true }}
              className="mb-2 sm:mb-3 inline-block rounded-full bg-blue-100 px-2 sm:px-3 py-1 text-xs sm:text-sm font-medium text-blue-800 dark:bg-blue-900/30 dark:text-blue-400"
            >
            ...
            <motion.h2
              ...
              viewport={{ once: true }}
              className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-bold tracking-tight text-gray-900 dark:text-white"
            >
            ...
            <motion.div
              ...
              viewport={{ once: true }}
              className="mx-auto mt-4 h-1 w-20 sm:w-24 rounded-full bg-blue-600"
            ></motion.div>
            ...
            <motion.p
              ...
              viewport={{ once: true }}
              className="mx-auto mt-4 sm:mt-6 max-w-3xl text-sm sm:text-base lg:text-lg text-gray-600 dark:text-gray-400 px-4"
            >
          ...
          <div className="grid gap-6 sm:gap-8 lg:grid-cols-2 lg:gap-12">
            ...
            >
              ...
              <motion.div
                ...
                transition={{ duration: 0.6, delay: 0.2 }}
                viewport={{ once: true }}
                className="rounded-xl bg-white p-4 sm:p-6 shadow-lg dark:bg-gray-800"
              >
              ...
              >
                <div className="flex items-center gap-2 sm:gap-3">
                  <div className="flex h-8 sm:h-10 w-8 sm:w-10 items-center justify-center rounded-full bg-blue-100 text-blue-600 dark:bg-blue-900/30 dark:text-blue-400">
          ...
          <motion.div className="mt-8 sm:mt-12 md:mt-16 lg:mt-20">
            <h3 className="mb-6 sm:mb-8 md:mb-12 text-center text-xl sm:text-2xl font-bold text-gray-900 dark:text-white">
            ...
            <div className="grid gap-4 sm:gap-6 sm:grid-cols-2 lg:grid-cols-4">
              {departments.map((dept, index) => (
                <motion.div
                  ...
                  viewport={{ once: true }}
                  className="rounded-xl bg-white p-4 sm:p-6 shadow-lg transition-all hover:shadow-xl dark:bg-gray-800"
                >
                  <div className="mb-3 sm:mb-4 flex h-10 w-10 sm:h-12 sm:w-12 items-center justify-center rounded-full bg-blue-100 text-blue-600 dark:bg-blue-900/30 dark:text-blue-400">
                    <dept.icon size={20} className="sm:w-6 sm:h-6" />
                  </div>
                  <h4 className="mb-2 text-base sm:text-lg font-bold text-gray-900 dark:text-white">
                    {dept.title}
                  </h4>
                  <p className="text-xs sm:text-sm text-gray-600 dark:text-gray-400">
                    {dept.description}
